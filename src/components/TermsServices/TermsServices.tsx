...
export default function TermsServices() {
  return (
    <div className="terms-services-container">
      ...
      <p>
        By accessing or using our Service, you agree to comply with and be bound by these Terms and all terms, policies, and guidelines incorporated by reference herein. If you do not agree to these Terms, you may not access or use the Service.
      </p>
      ...
      <h2>User Accounts</h2>
      <p>
        If the Service requires you to register for an account, you agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete.
      </p>
      <p>
